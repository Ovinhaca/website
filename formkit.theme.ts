 ...
 *
 * @checksum - d0a47c067b4ad6c253dfc81cafe8dfa0a3cfa52dbacada26bb286ea62630db83
 * @variables - radius=rounded,accentColor=amber,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
